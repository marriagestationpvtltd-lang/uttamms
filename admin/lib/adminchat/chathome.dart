...
class _ChatWindowState extends State<ChatWindow> {
  ...
  void _initializeWebSpeech() {
    ...
    _webSpeechRecognition!['onresult'] = js_util.allowInterop((dynamic event) {
    ...
    _webSpeechRecognition!['onend'] = js_util.allowInterop((dynamic _) {
    ...
    _webSpeechRecognition!['onerror'] = js_util.allowInterop((dynamic event) {
      if (!mounted) return;
      final error =
