...
-- Step 2-pre: Create the user_documents table if it does not exist at all.
--             This makes the migration safe to run on databases that were
--             initialised from an older schema that pre-dates the table.
...
-- =============================================================================
-- 12. Short Video / Story Ecosystem (Phase 2)
-- =============================================================================
